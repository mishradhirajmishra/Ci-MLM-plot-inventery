...
<div class="page-content">
    ...
    <div class="row">
      ...
      <?php if($row['status']==1){ echo '<div class="col-xs-6 col-sm-3"><button  style="margin-bottom:4px;  width: 100%;font-size: 13px;    text-align: left;" class="btn btn-success">';?> <?php $s=$this->user_model->list_sector_byid($row['sr_no']);echo $s ['sec_name'];?>
      <?php echo '<span class="badge" style="color:red">'; echo $row['plot_no'];  echo '</span></button></div>';}
                else{ }?>
        <?php }?>
