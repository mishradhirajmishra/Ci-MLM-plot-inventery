	...
	<div class="page-header">
		...
		<div class="col-xs-12">
										...
										<div class="table-header">
											All Users Incentive By Closing Date
										</div>
        					...
        					if(!empty($status)){
        						...
        						$url=base_url()."index.php/admin/paynow/".$id.'/'.$date['generation_date'];
        					if($status[0]['status']==0){
        						echo '<span class="label label-sm label-warning">Due</span>';
  echo '<a class= "label label-success arrowed" href="'.$url.'">Pay Now</a>';
        					}else 
