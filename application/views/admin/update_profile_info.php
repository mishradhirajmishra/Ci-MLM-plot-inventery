...
<div class="row">
		<div class="col-xs-12">
		<form class="form-horizontal" method="post" action="<?php echo base_url();?>index.php/admin/update_profile" role="form">
				...
				<div class="form-group">
						...
						<div class="col-sm-9">
							<select name="status">
								...
								<option value="0" <?php if($info[0]['status']==0) echo "selected" ?>>In-Active</option>
							</select>
						</div>
				</div>
